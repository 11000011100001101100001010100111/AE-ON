...
class TERM_Harvester:
    def __init__(self):
        ...
        self.headers = {'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) TERM_Bot/6.0'}
        self.states = {}
    ...
    def draw_dashboard(self, current_action="Initializing..."):
        ...
        print(f"{C_BRASS}   TERM HARVESTER v6.0 | MASS FIX{C_RESET}")
        print(f"{C_RED}========================================{C_RESET}")
    ...
    def clean_text(self, text):
        if not text: return ""
        # CRITICAL FIX: Only remove citations like [1], [a], [note 1]
        # Do NOT remove ranges like [1.008, 1.009]
    ...
    def fetch_master_index(self):
        ...
        self.draw_dashboard("COMPLETE. Mass data secured.")
    ...
    def update_profile(self, name, url, save_dir):
        ...
        profile_data = {
            ...
            "atomic_mass": atomic_mass_found, # DEDICATED FIELD
