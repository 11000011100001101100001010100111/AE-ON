...
class TERM_TUI:
    ...
    def draw_header(self):
        title = " T.E.R.M. v1.7 [FUSION FIXED] "
    ...
    def draw_lab(self):
        ...
        # Stability Heuristic (Ratio N/Z)
        ratio = self.lab_n / self.lab_z if self.lab_z > 0 else 0
        stable = "STABLE"
        if self.lab_z > 83 or ratio < 1.0 or ratio > 1.6:
            stable = "UNSTABLE"
        if self.lab_z == 1 and self.lab_n == 0: stable = "STABLE" # Hydrogen Exception
